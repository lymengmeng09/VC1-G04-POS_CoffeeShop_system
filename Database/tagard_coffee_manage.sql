...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2025 at 02:53 PM
...
CREATE TABLE `activity_logs` (
  ...
  `affected_item_type` varchar(50) DEFAULT NULL,
  `affected_item_id` int(11) DEFAULT NULL,
...
CREATE TABLE `backups` (
  ...
  `backup_type` enum('Full','Partial') DEFAULT NULL,
...
--
-- Indexes for table `two_factor_authentication`
--
...
--
-- AUTO_INCREMENT for table `two_factor_authentication`
--
ALTER TABLE `two_factor_authentication`
...
--
-- Constraints for table `two_factor_authentication`
--
ALTER TABLE `two_factor_authentication`
  ADD CONSTRAINT `two_factor_authentication_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
