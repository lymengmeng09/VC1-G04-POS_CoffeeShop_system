<div class="table-container">
        ...
        <div class="input-group" style="max-width: 330px; height:40px;">
            <input type="text" class="form-control" id="searchInput" placeholder="Search" aria-label="Search" oninput="searchTable()">
    ...
    <?php if (!empty($users)): ?>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td>
                    <button class="btn text-dark btn-warning">Edit</button>
                    <button class ="btn btn-danger">Delete</button>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="6" id="noResultsMessage" style="display: none;">No records found</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
