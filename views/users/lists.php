        ...
        <tbody>
            ...
            ?>
                <?php foreach ($filteredUsers as $user): ?>
                    <tr>
                        <td class="py-2 " style="padding-left: 30px;"><img src="/<?= !empty($user['profile']) ? htmlspecialchars($user['profile']) : 'views/assets/images/profile.png' ?>" alt="" class="rounded-circle me-2" style="width: 40px; height:40px;">
                        ...
                        <?php if (AccessControl::isAdmin()): ?>
                            <td class="text-start ps-0" style="padding-right: 10px;">
