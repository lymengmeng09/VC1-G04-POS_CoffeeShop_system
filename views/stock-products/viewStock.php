         ...
         <div class="table-responsive">
             <table class="table table-hover align-middle table-bordered">
                 <thead class="text-white">
                     <tr>
                         <th class="text-white text-center"><?php echo __('products'); ?></th>
                         <th class="text-white text-center"><?php echo __('price'); ?></th>
                         <th class="text-white text-center"><?php echo __('stock'); ?></th>
                         <th class="text-white text-center"><?php echo __('status'); ?></th>
                         <th class="text-white text-center"><?php echo __('Action'); ?></th>
                     </tr>
                 </thead>
                 <tbody>
                     ...
                     <tr>
                         ...
                         <td class="fw-semibold text-primary text-center">$<?= number_format($product['price'], 2) ?></td>
             ...
             <div class="modal-footer">
                 <form id="deleteForm" method="POST">
                     ...
                     <button type="button" class="btn btn-outline-secondary"
                         data-bs-dismiss="modal"><?php echo __('cancel'); ?></button>
                 </form>
             </div>
         </div>
     </div>
                 ...
                 <form method="POST" action="/add-product" enctype="multipart/form-data" id="addProductForm">
                         ...
                         <div class="product-entry mb-3">
                             <div class="row g-3 align-items-end">
                                 ...
                                 <div class="col-md-2">
                                     ...
                                     <input type="number" step="0.01" class="form-control" id="addPrice-0"
                                         name="price[]" required>
                                 </div>
                                 <div class="col-md-2">
                                     <label for="addQuantity-0"
                                         class="form-label"><?php echo __('Stock Quantity'); ?></label>
                                     <input type="number" class="form-control" id="addQuantity-0" name="quantity[]"
                                         required>
                                 </div>
                                 <div class="col-md-3">
                                     <label for="addImage-0"
                                         class="form-label"><?php echo __('upload_image'); ?></label>
                     ...
                     <div class="d-flex justify-content-between">
                         <button type="button" class="btn btn-outline-primary"
                             id="add-more-product"><?php echo __('Add More'); ?></button>
                 ...
                 <form method="POST" action="/update-stock" id="updateProductForm">
                     <div id="product-entries">
                         <div class="product-entry mb-3">
                             <div class="row g-3 align-items-end">
                                 <div class="col-md-3">
                                     <label for="updateProduct-0"
                                         class="form-label"><?php echo __('Select Product'); ?></label>
                                     <select class="form-control update-product" id="updateProduct-0"
                                 ...
                                 <div class="col-md-2">
                                     <label for="updateQuantity-0"
                                         class="form-label"><?php echo __('quantity'); ?></label>
                                     <input type="number" class="form-control update-quantity" id="updateQuantity-0"
                                         name="quantity[]" required>
                                 </div>
                                 <div class="col-md-2">
                                     <label for="totalPrice-0"
                                         class="form-label"><?php echo __('Total Price'); ?></label>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <p style="padding: 10px 20px; font-size: 16px; margin-right: 5%; color: black;"><strong>Action:
                     </strong><?= ucfirst($_SESSION['receipt']['action']) ?> </p>
             ...
             <div class="modal-footer">
                 <button type="button" class="btn btn-success" id="save-pdf"
                     style="padding: 10px 20px; font-size: 16px; margin-right: 5%;" onclick="savePDFAndRedirect()">Save
                     PDF</button>
                 <button type="button" class="btn btn-primary" id="ok-button" data-bs-dismiss="modal"
                     style="padding: 10px 20px; font-size: 16px; margin-left: 45%;"
                     onclick="ConceldRedirect()">OK</button>
             </div>
         </div>
     </div>
 </div>
